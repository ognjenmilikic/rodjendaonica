	...
	<div class="container-fluid section-2">
		...
		<div class="row d-flex justify-content-center">
			<div class="col-md-3 danger-section p-4 mt-5">
				<p class="m-0">Uneti email već postoji u bazi, idite na <a href="login.jsp">login</a> ili se registrujte sa drugim mejlom</p>
			</div>
		</div>
		<% } %>
		<div class="row d-flex justify-content-center">
			<div class="col-md-3 py-5">
				<form method="post" action="registracijaServlet">
					...
					<button type="submit" class="btn btn-lg btn-2">Potvrdi</button>
				</form>
			</div>
		</div>
	</div>
